TEXTS = [
    [
        ...
        [
            ...
            {text:"Boots even shares his Chocolate Cake, his favourite treat.", time:97},
            {text:"Now Boots is very happy too.", time: 100},
            {text:"Because sharing made Sock happy, and sharing is good to do.", time:106}
        ],
        [
    ...
    [
        ...
        [
            ...
            {text:"He'll get ready for bed, then he'll turn out his light,", time:26 + 14},
            {text:"but Sock is afraid of the dark at night", time:45}
        ],

        [
            {text:"He pulls his covers up to his head,", time:45 + 3},
            {text:"and lies there shaking in his bed.", time:45 + 6.5},
            {text:"\"I'm scared, I'm scared\" Sock begins to shout.", time:45 + 11.5},
            {text:"\"I don't like when the lights go out\"", time:60}
        ],

        [
            {text:"Sock doesn't like to turn out the light,", time:60 + 4},

            {text:"because the house makes scary noise at night.", time:60 + 8},
            {text:"Now it's dark inside Sock's room,", time:60 + 11},
            {text:"except for the light from the shining moon", time:75}
        ],

        [
            {text:"Squeak.....squeak....... goes the floor.", time:75 + 5.5},

            {text:"Is that a noise coming from the closet door?", time:76 + 8},
            {text:"The very thought gives Sock a really big scare.", time:76 + 12},
        ...
        [
            {text:"Just to be sure Sock looks all around,", time:120 + 5},

            {text:"then he hops back in bed to sleep safe and sound.", time:120 + 11},
            {text:"\"I'm glad I checked for myself,\" says Sock.", time:120 + 15},
    ...
    [
        ...
        [
            {text:"Sock wants to play in the washing machine.", time:23 + 3},
