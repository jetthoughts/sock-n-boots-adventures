...
TEXTS = [
    ...
    [
        ...
        [
            {text:"Tick..tock...tick...tock.", x:DEFAULT_X, y:DEFAULT_Y, time:5.5},

            {text:"The clock strikes 8 and its bedtime for Sock", x:DEFAULT_X, y:DEFAULT_Y, time:10},
            {text:"He'll get ready for bed, then he'll turn out his light,", x:DEFAULT_X, y:DEFAULT_Y, time:14},
            {text:"but Sock is afraid of the dark at night", x:DEFAULT_X, y:DEFAULT_Y, time:19}
        ],
        ...
        [
            ...
            {text:"Is there really a monster behind the door?", x:DEFAULT_X, y:DEFAULT_Y, time:15}
        ],
